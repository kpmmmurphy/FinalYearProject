...
mv ~/FinalYearProject/camera/still/* ~/FinalYearProject/camera/still_backup/

DATE=$(date +"%Y-%m-%d_%H%M")
#DATE=$(zdump GMT)

raspistill -vf -hf --width 1080 --height 720 --quality 100 -o ~/FinalYearProject/camera/still/$DATE.jpg
